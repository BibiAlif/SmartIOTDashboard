...
export function GovSmartParkingRipasBook() {
...
<div key={index} className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-2 ">
  ...
  <div className="mt-14 mb-4 flex flex-col gap-6" >
    <Card>
      <CardHeader variant="gradient" color="gray" className="mb-8 p-6">
        <Typography variant="h6" color="white">Parking Hospital Ripas Book</Typography>
      </CardHeader>
      ...
      <form className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
        ...
        <Button className="w-full md:w-40 mb-4">Submit</Button>
          <Link to="/dashboardGov/govSmartParkingRipas">
...
export default GovSmartParkingRipasBook;