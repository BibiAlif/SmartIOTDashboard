...
export function GovSmartParkingJayaSetiaCCTV() {
  return (
...
<div key={index} className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-2 ">
  ...
  <div className="mt-14 mb-4 flex flex-col gap-6" >
    <Card>
      ...
      <Link to="/dashboardGov/govSmartParkingJayaSetia"><Button className="w-full md:w-40 mb-4">Back</Button></Link>
...
export default GovSmartParkingJayaSetiaCCTV;