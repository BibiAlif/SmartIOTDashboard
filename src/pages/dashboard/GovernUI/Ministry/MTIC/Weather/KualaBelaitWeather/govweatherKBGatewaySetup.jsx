...
export function GovWeatherKBGatewaySetup() {
  return (
    
    <div className="mt-14 mb-4 flex flex-col gap-6" >
    <Card>
      <CardHeader variant="gradient" color="gray" className="mb-8 p-6">
        <Typography variant="h6" color="white">Kuala Belait Gateway Setup</Typography>
      </CardHeader>
    </Card>
...
<div className="mb-6 grid grid-cols-1 gap-x-6 md:grid-cols-2 xl:grid-cols-3">
 ...
 {/* Card Will be here -------------------------------------------------------------------------*/}  
  <Card className="mt-6 w-30 h-55 text-center">
    ...
    <Link to="/dashboardGov/govweatherKBGatewayConnect"><Button>Setup Gateway</Button></Link>
    </CardFooter>
  </Card>
  {/* Card Will be here -------------------------------------------------------------------------*/}  
...
export default GovWeatherKBGatewaySetup;