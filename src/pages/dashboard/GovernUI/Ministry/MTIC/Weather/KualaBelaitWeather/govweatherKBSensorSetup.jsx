...
export function GovWeatherKBSensorSetup() {
  return (
...
<div className="mb-6 grid grid-cols-1 gap-x-6 md:grid-cols-2 xl:grid-cols-3">
 ...
 {/* Card Will be here -------------------------------------------------------------------------*/}  
  <Card className="mt-6 w-30 h-55 text-center">
    ...
    <Link to="/dashboardGov/govweatherKBSensorConnect"><Button>Setup Sensor</Button></Link>
    </CardFooter>
  </Card>
 {/* Card Will be here -------------------------------------------------------------------------*/}  
...
export default GovWeatherKBSensorSetup;