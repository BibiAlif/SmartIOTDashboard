...
export function GovWeatherKBSensorConnect() {
  return (
    
    <div className="mt-14 mb-4 flex flex-col gap-6" >
    <Card>
      <CardHeader variant="gradient" color="gray" className="mb-8 p-6">
        <Typography variant="h6" color="white">Kuala Belait Sensor Connect</Typography>
      </CardHeader>
    </Card>
...
export default GovWeatherKBSensorConnect;