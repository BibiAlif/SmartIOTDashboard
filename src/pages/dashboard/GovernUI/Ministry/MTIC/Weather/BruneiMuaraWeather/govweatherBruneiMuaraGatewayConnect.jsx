...
export function GovWeatherBruneiMuaraGatewayConnect() {
  return (
    
    <div className="mt-14 mb-4 flex flex-col gap-6" >
    <Card>
      <CardHeader variant="gradient" color="gray" className="mb-8 p-6">
        <Typography variant="h6" color="white">Brunei Muara Gateway Connect</Typography>
      </CardHeader>
    </Card>
...
<div className="mt-14 mb-4 flex flex-col gap-6" >
    <Card>
      <CardHeader variant="gradient" color="gray" className="mb-8 p-6">
        <Typography variant="h6" color="white">UG67 LoRaWAN Gateway Data Transmitted At Brunei Muara</Typography>
      </CardHeader>
      </Card>
...
export default GovWeatherBruneiMuaraGatewayConnect;