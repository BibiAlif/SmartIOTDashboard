...
export function GovWeatherBruneiMuaraGatewwaySetupForm() {
  return (
    
    <div className="mt-14 mb-4 flex flex-col gap-6" >
    <Card>
      <CardHeader variant="gradient" color="gray" className="mb-8 p-6">
        <Typography variant="h6" color="white">Brunei Muara Setup Gateway Form</Typography>
      </CardHeader>
    </Card>
...
export default GovWeatherBruneiMuaraGatewwaySetupForm;